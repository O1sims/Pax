System.register(["@angular/core", "@angular/http", "ng2-nvd3", "angular2-modal", "leaflet", "angular2-modal/plugins/bootstrap", "./asset.info.modal.service", "../../risk-graph.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, ng2_nvd3_1, angular2_modal_1, L, angular2_modal_2, bootstrap_1, asset_info_modal_service_1, risk_graph_service_1, AssetInfoWindowData, AssetInfoWindow;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            AssetInfoWindowData = class AssetInfoWindowData extends bootstrap_1.BSModalContext {
                constructor(assetInfoData, riskInfo, systemId, systemData, missionData) {
                    super();
                    this.assetInfoData = assetInfoData;
            ...
            exports_1("AssetInfoWindowData", AssetInfoWindowData);
            AssetInfoWindow = class AssetInfoWindow {
                constructor(dialog, vcRef, modal, assetInfoService, riskGraphService) {
                    this.dialog = dialog;
                    this.modal = modal;
                ...
                populateActionTable() {
                    this.actionRows = [];
                    this.riskGraphService.getMissionData(this.missionData['globalId']).subscribe(missionData => {
                        this.missionData = missionData;
                        for (let i = 0; i < missionData['coAs'].length; i++) {
                ...
                submitNewAction() {
                    ...
                    this.riskGraphService.postTask(this.missionData['globalId'], this.selectedCOA['id'], task).subscribe(postedTask => {
                        this.populateActionTable();
                    });
                }
                ;
                deleteAction(event) {
                    this.riskGraphService.deleteTask(this.missionData['globalId'], event['courseOfActionId'], event['id']).subscribe(deletedAction => {
                        this.populateActionTable();
                    });
                }
                assetView() {
            ...
            AssetInfoWindow = __decorate([
                core_1.Component({
                    selector: 'modal-content',
                    templateUrl: './app/risk-graph/modals/asset-info/asset.info.modal.html',
                    directives: [ng2_nvd3_1.nvD3],
                    providers: [asset_info_modal_service_1.AssetInfoService, risk_graph_service_1.RiskGraphService, angular2_modal_1.Modal, http_1.HTTP_PROVIDERS]
                }),
                __metadata("design:paramtypes", [angular2_modal_2.DialogRef,
                    core_1.ViewContainerRef,
                    angular2_modal_1.Modal,
                    asset_info_modal_service_1.AssetInfoService,
                    risk_graph_service_1.RiskGraphService])
            ], AssetInfoWindow);
            exports_1("AssetInfoWindow", AssetInfoWindow);
        }
    };
});
//# sourceMappingURL=asset.info.modal.js.map